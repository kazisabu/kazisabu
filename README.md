...
public class EXPERIENCE {
    ...
    public string Role3   = "Cybersec Trainner @ Basify";
    public string Role4   = "CTO @ BinaryShilders";
...
public static class SOCIAL_MEDIA {
    public void codeLinks() {
        var LinkedIn = "https://www.linkedin.com/in/kazisabbir/";
